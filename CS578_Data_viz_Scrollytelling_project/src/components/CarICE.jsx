/* ICE top-down silhouette */
export default function CarICE(props) {
  return (
    <svg
      {...props}
      viewBox="0 0 60 110"
    ...
    >
      <rect x="10" y="10" width="40" height="90" rx="12" fill="#FF6A4A" />
      <rect x="16" y="35" width="28" height="40" rx="8" fill="rgba(255,255,255,0.22)" />
